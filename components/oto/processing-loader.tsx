...
export function ProcessingLoader({
  ...
  if (isPaso2) {
    return (
      <div className={cn('tone-ember fixed inset-0 z-50 flex items-start justify-center overflow-y-auto bg-background px-2 pb-3 pt-14 text-foreground transition-opacity duration-500', closing && 'pointer-events-none opacity-0')} role="status" aria-live="polite">
        <div className="flex min-h-full w-full max-w-[300px] flex-col gap-3 pb-16">
